/**
 * Backend Gemini Multimodal Vision API Integration
 * Securely uses the GEMINI_API_KEY from environment variables.
 */

export async function analyzeLabelWithGemini(imageBase64, customApiKey = null) {
  const apiKey = customApiKey || process.env.GEMINI_API_KEY;

  if (!apiKey) {
    throw new Error('Gemini API key is missing. Please add GEMINI_API_KEY to your backend .env file or provide it in the request.');
  }
